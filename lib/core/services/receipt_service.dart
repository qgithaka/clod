        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Divider(),
              pw.Text('RECEIPT #$saleId', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
              pw.Text(DateTime.now().toString().split('.')[0]),
              if (cart.customer != null) pw.Text('Customer: ${cart.customer!.name}'),
              pw.Divider(),
              ...cart.items.map((line) => pw.Row(
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(cart.total.format(), style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 16)),
                ],
              ),
              pw.SizedBox(height: 4),
              pw.Text('Payment Method: ${isCredit ? 'CREDIT' : 'CASH'}'),
              pw.SizedBox(height: 16),
              pw.Text('Thank you for your business!', textAlign: pw.TextAlign.center),
            ],
          );
        },
      ),
