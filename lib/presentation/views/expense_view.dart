...
class ExpenseFilter {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ExpenseFilter && startDate == other.startDate && endDate == other.endDate;
  
  @override
  int get hashCode => startDate.hashCode ^ endDate.hashCode;
}

final expenseListProvider = StreamProvider.family<List<Expense>, ExpenseFilter>((ref, filter) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text('${DateFormat.yMd().add_Hm().format(DateTime.fromMillisecondsSinceEpoch(e.occurredAt))}\n${e.note ?? ''}'),
                      trailing: Text(Money(e.amountCents).format(), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              content: Column(
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    items: ['Supplies', 'Rent', 'Utilities', 'Payroll', 'Marketing', 'Other'].map((c) => DropdownMenuItem(value: c, child: Text(c))).toList(),
