  ...
  Future<int> processCheckout(CartState cart, bool isCredit) async {
    ...
    return await _db.transaction(() async {
      ...
      for (final line in cart.items) {
        await _db.saleDao.insertSaleItem(SaleItemsCompanion.insert(
          saleId: saleId,
          itemId: line.item.id,
      ...
      if (isCredit && cart.customer != null) {
        ...
        await _db.creditTransactionDao.insertTransaction(CreditTransactionsCompanion.insert(
          customerId: custId,
        ...
        await _db.customerDao.updateCustomer(CustomersCompanion(
          ...
          currentBalanceCents: Value(custRec.currentBalanceCents + cart.total.cents),
